	...
	<div class="max-w-4xl mx-auto">
      ...
      {#await taggedTasksPromise}
        ...
        {:else}
          <div class="p-4">
            <!-- Task table header -->
            <div class="task-header grid grid-cols-[1fr_auto_auto] gap-4 py-2 px-2 items-center font-semibold border-b border-base-300 mb-2">
              <div>Task</div>
            ...
            {#each taggedTasks as task (task.id)}
              <div class="task-row grid grid-cols-[1fr_auto_auto] gap-4 py-3 px-2 items-start hover-parent" class:completed={task.completed}>
                <div class="task-content">
                  <div class="task-text" class:line-through={task.completed}>{task.name}</div>
                </div>
                <div class="task-date text-sm text-base-content/70 self-center">
